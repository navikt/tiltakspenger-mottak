...
dependencies {
    ...
    implementation("no.nav.security:token-client-core:2.0.20")
...
//    implementation("io.micrometer:micrometer-registry-prometheus:1.8.1")
    ...
    // Kafka
    implementation("org.apache.kafka:kafka-clients:7.1.1-ce")
    ...
    testImplementation("io.quarkus:quarkus-junit4-mock:2.9.1.Final")
}
